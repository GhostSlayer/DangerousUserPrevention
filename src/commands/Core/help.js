        ...
        if (!cmd) {
            ...
            message.channel.createMessage({
                embed: {
                    ...
                    description: `Prefix: \`${guildSettings && guildSettings.prefix ? guildSettings.prefix : process.env.PREFIX}\` \nType \`${guildSettings && guildSettings.prefix ? guildSettings.prefix : process.env.PREFIX}help [command name]\` for command specific information.`,
